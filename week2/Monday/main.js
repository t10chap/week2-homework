...
var age2 = '22';
var address = '2080 Vallejo st';
var greeting2 = ("Hello, I'm " + '${name2}' + " I'm " + '${age2}' + " years old and live in " + '${address2}');
...
Within loop, create if condition;
	create a variable to store index value
	if current index is < next index set variable to that index
	if not keep current value from previous index
Once for loop is broken and conditions aren't met print current number stored in variable
*/
